...
export type Channels = 'save' | 'saveAs' | 'open' | 'window' | 'getSettings' | 'setSettings' | 'resetSettings' | 'loadFile' | 'getRecent' | 'getLastFile' | 'toggleFullscreen' | 'newWindow' | 'showSaveDialog' | 'getVersionInfo' | 'checkForUpdates' | 'close' | 'getLocalFile' | 'getLocalFileBase64' | 'exportToPDF' | 'showInFolder' | 'getFileContent' | 'exportWindowLoad' | 'getText' | 'availableDictionaries' | 'loadSpellchecker' | 'spellcheck' | 'suggest' | 'addToUserDictionary';
